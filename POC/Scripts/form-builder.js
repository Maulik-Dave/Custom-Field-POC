    ...
    !(function (e) {
        ...
        function (t, r, o) {
            ...
            const s = function (e, t = !1) {
                ...
                f = (e, t) => {
                    let r;
                    return (e = m(e)), t && (Array.isArray(t) ? (r = k(t.join(" "))) : ("boolean" == typeof t && (t = t.toString()), (r = k(t.trim())))), { name: e, value: (t = t ? `="${r}"` : "") };
                },
            ...
            const G = (e) => Object.entries(e).reduce((e, [t, r]) => i(i({}, e), {}, { [t + "Selector"]: "." + r }), {});
            r.g = Y;
        },
        function (e, t, r) {
            r.d(t, "a", function () {
        ...
        function (e, t, r) {
            ...
            r.n(o).a.addLanguage("en-US", {
                ...
                enableOptionsValueMsg: "Enter unique data in the Value field",
            ...
            const i = {
                ...
                s = {},
                d = { rowWrapperClass: "rowWrapper", colWrapperClass: "colWrapper", tmpColWrapperClass: "tempColWrapper", tmpRowPlaceholderClass: "tempRowWrapper", invisibleRowPlaceholderClass: "invisibleRowPlaceholder" },
                c = 333,
                u = "li.form-field";
        },
        function (e, t, r) {
        ...
        function (t, r, o) {
            ...
            class p extends n.a {
                build() {
                    ...
                    return n[t] && (o = n[t]), { field: this.markup(o, u.g.parsedHtml(this.label), r), layout: "noLabel" };
                }
            }
            function m(e, t) {
                if (null == e) return {};
            ...
            class b extends n.a {
                ...
                build() {
                    ...
                    return (this.dom = "select" == i ? this.markup(c, e, Object(u.D)(d, !0)) : this.markup("div", e, { className: i })), this.dom;
                }
                groupRequired() {
            ...
            class k extends w {
                configure() {
                    ...
                    Object.assign(this, C(C({}, { js: "//cdn.quilljs.com/1.2.4/quill.js", css: "//cdn.quilljs.com/1.2.4/quill.snow.css" }), t)), (this.editorConfig = C(C({}, e), r));
                }
                build() {
                    const e = this.config,
                        { value: t = "" } = e,
        ...
        function (t, r, o) {
            ...
            class y {
                                ...
                                if (!i.hasClass("disabled-field")) {
                                    ...
                                    if (
                                        (s.length && (l.role = s.join(",")),
                                            (l.className = l.className || l.class),
                                            l.className && "true" == i.attr("addeddefaultcolumnclass") && 1 == i.closest(this.formBuilder.rowWrapperClassSelector).children().length && l.className.includes(m.a.opts.defaultGridColumnClass))
                                    ) {
                ...
                getData(e) {
                    ...
                    const r = { xml: (e) => (Array.isArray(e) ? e : Object(p.w)(e)), json: (e) => ("string" == typeof e ? window.JSON.parse(e) : e) };
                ...
                disabledTT(e) {
                    ...
                    Object(p.j)(t, (e) => {
                        ...
                        if (o) {
                            const e = Object(p.t)("p", o, { className: "frmb-tt" });
                            r.appendChild(e),
                ...
                showOverlay() {
                    const e = Object(p.t)("div", null, { className: "form-builder-overlay" });
                ...
                confirm(e, t, r = !1, o = "") {
                    const n = this,
                        i = c.a.current,
                        l = n.showOverlay(),
                        a = Object(p.t)("button", i.yes, { className: "yes btn btn-success btn-sm" }),
                        s = Object(p.t)("button", i.no, { className: "no btn btn-danger btn-sm" });
                    (s.onclick = function () {
                        n.closeConfirm(l);
                    }),
                        (a.onclick = function () {
                    ...
                    const d = Object(p.t)("div", [s, a], { className: "button-wrap" });
                    o = "form-builder-dialog " + o;
                    const u = Object(p.t)("div", [e, d], { className: o });
                ...
                dialog(e, t = !1, r = "") {
                    ...
                    const i = Object(p.t)("div", e, { className: r });
                    return (
                ...
                showData() {
                    ...
                    const t = Object(p.t)("code", e, { className: "formData-" + m.a.opts.dataType });
                ...
                editorUI(e) {
                    const t = this.d,
                        r = this.data,
                        o = e || r.formID;
                    (t.editorWrap = Object(p.t)("div", null, { id: r.formID + "-form-wrap", className: "form-wrap form-builder " + Object(p.u)() })),
                        (t.stage = Object(p.t)("ul", null, { id: o, className: "frmb stage-wrap " + r.layout.stage })),
                        (t.controls = Object(p.t)("ul", null, { id: o + "-control-box", className: "frmb-control" }));
                    const n = this.formActionButtons();
                    t.formActions = Object(p.t)("div", n, { className: "form-actions btn-group" });
                }
                formActionButtons() {
                    const e = m.a.opts;
            ...
            class v {
                ...
                setupControls() {
                    ...
                    for (let e = 0; e < t.length; e++) {
                        ...
                        const s = Object(p.t)("li", Object(p.t)("span", l), { className: `${a} input-control input-control-${e}` });
                    ...
                    e.inputSets.length &&
                        e.inputSets.forEach((e, t) => {
                            ...
                            const n = Object(p.t)("li", o, { className: "input-set-control input-set-" + t });
                ...
                orderFields(e) {
                    ...
                    return (
                        ...
                        o ? ((o = window.JSON.parse(o)), (o = Object(p.E)(o.concat(e))), (o = Object.keys(o).map((e) => o[e]))) : (o = Object(p.E)(r)),
                        o.forEach((e) => {
            ...
            const { rowWrapperClass: j, colWrapperClass: k, tmpColWrapperClass: q, tmpRowPlaceholderClass: E, invisibleRowPlaceholderClass: N } = m.f,
                { rowWrapperClassSelector: S, colWrapperClassSelector: T, tmpColWrapperClassSelector: D, tmpRowPlaceholderClassSelector: B, invisibleRowPlaceholderClassSelector: L } = Object(p.l)(m.f);
            let R = !1;
            function I(e, t, r) {
                const o = this,
                    n = c.a.current,
                ...
                const X = C("div", b.controls, { id: d.formID + "-cb-wrap", className: "cb-wrap " + d.layout.controls });
                e.showActionButtons && X.appendChild(b.formActions);
                const J = C("div", "", { id: d.formID + "-gridModeHelp", className: "grid-mode-help" });
                X.appendChild(J),
                    G.append(b.stage, X),
                    "textarea" !== t.type ? r(t).append(G) : r(t).replaceWith(G),
                ...
                const K = function (t) {
                    (t = A.getData(t)) && t.length
                        ...
                        : e.defaultFields && e.defaultFields.length
                            ? (m.a.opts.defaultFields.forEach((e) => $(e)), A.addDefaultFields())
                            : e.prepend || e.append || (b.stage.classList.add("empty"), (b.stage.dataset.content = c.a.get("getStarted"))),
                        (() => {
                            const t = [],
                                o = (t) => C("li", e[t], { className: "disabled-field form-" + t });
                            return (
                                e.prepend && !r(".disabled-field.form-prepend", b.stage).length && (t.push(!0), P.prepend(o("prepend"))),
                                e.append && !r(".disabled-field.form-.append", b.stage).length && (t.push(!0), P.append(o("append"))),
                    ...
                    const { type: r } = t,
                        ...
                        i = ((e) => {
                            const t = ["required", "label", "description", "placeholder", "className", "name", "access", "value"],
                                ...
                                o = {
                                    autocomplete: t.concat(["optionsValueMsg","options", "requireValidOption"]),
                                    button: ["label", "subtype", "style", "className", "name", "value", "access"],
                                    checkbox: ["required", "label", "description", "toggle", "inline", "className", "name", "access", "other", "optionsValueMsg","options"],
                                    ...
                                    select: t.concat(["multiple", "optionsValueMsg","options"]),
                        ...
                        l = {
                            required: () => ce(t),
                            toggle: () => ie("toggle", t, { first: c.a.get("toggle") }),
                            inline: () => {
                            ...
                            other: () => ie("other", t, { first: c.a.get("enableOther"), second: c.a.get("enableOtherMsg") }),
                            /*optionsValueMsg: () => c.a.get("enableOptionsValueMsg"),*/
                            optionsValueMsg: () => ie("enableOptionsValueMsg", t, { first: "Option & Value", second: c.a.get("enableOptionsValueMsg") }),
                            options: () =>
                                (function (e) {
                                    const { type: t, values: r } = e;
                                    let o;
                                    const n = [C("a", c.a.get("addOption"), { className: "add add-opt" })],
                                        i = [C("label", c.a.get("selectOptions"), { className: "false-label" })],
                                        l = e.multiple || "checkbox-group" === t,
                                        a = (e) => {
                                            const t = c.a.get("optionCount", e);
                                            return { selected: !1, label: t, value: Object(p.q)(t) };
                                        };
                                    ...
                                    const s = C("div", n, { className: "option-actions" }),
                                        d = C(
                                            "ol",
                                            o.map((e, r) => {
                                        ...
                                        u = C("div", [d, s], { className: "sortable-options-wrap" });
                                    return i.push(u), C("div", i, { className: "form-group field-options" }).outerHTML;
                                })(t),
                            requireValidOption: () => ie("requireValidOption", t, { first: " ", second: c.a.get("requireValidOption") }),
                            multiple: () => {
                                const e = {
                ...
                function ne(e, t) {
                    const { multiple: r, options: o, label: i, value: l, class: a, className: s } = t,
                        ...
                        f = Object.keys(o).map((e) => {
                            ...
                            return (Array.isArray(l) ? l.includes(e) : e === l) && (t.selected = null), C("option", n, t);
                        }),
                    ...
                    return `<div class="form-group ${e}-wrap">${m}${`<div class="input-wrap">${C("select", f, p).outerHTML}</div>`}</div>`;
                }
                const ie = (e, t, r = {}) => {
                    debugger;
                    if (e == "enableOptionsValueMsg") {

                        const o = (t) => C("label", t, { for: `${e}-${d.lastID}` }).outerHTML;
                        const i = [];
                        let l = [];
                        return (
                            ...
                            (l = C("div", l, { className: "input-wrap" }).outerHTML),
                            C("div", i.concat(l), { className: `form-group ${e}-wrap` }).outerHTML
                        );
                    }
                    else {
                        const o = (t) => C("label", t, { for: `${e}-${d.lastID}` }).outerHTML,
                    ...
                    le = (e) => {
                        ...
                        return (
                            (t += A.input({ value: e || "default", type: "hidden", className: "btn-style" }).outerHTML),
                            (t += '<div class="btn-group" role="group">'),
                            m.g.btn.forEach((r) => {
                                const o = ["btn-xs", "btn", "btn-" + r];
                                e === r && o.push("selected");
                                const n = C("button", c.a.get("styles.btn." + r), { value: r, type: "button", className: o.join(" ") }).outerHTML;
                                t += n;
                            }),
                            (t += "</div>"),
                            (t = C("div", [r, t], { className: "form-group style-wrap" })),
                            t.outerHTML
                        );
                    },
                    ae = (e, t) => {
                        ...
                        return C("div", [`<label for="${a.id}">${l}</label>`, `<div class="input-wrap">${s}</div>`], { className: `form-group ${e}-wrap` }).outerHTML;
                    },
                    se = (e, t, r) => {
                        const o = r.map((r, o) => {
                            ...
                            a = C("label", l, { for: i.id }),
                            s = C("select", o, i),
                            u = C("div", s, { className: "input-wrap" });
                        return C("div", [a, u], { className: `form-group ${i.name}-wrap` }).outerHTML;
                    },
                    de = (t, r, o = !1) => {
                        const n = ["paragraph"];
                        let i = r[t] || "",
                        ...
                        if (![].some((e) => !0 === e)) {
                            const n = { name: t, placeholder: a, className: `fld-${t} form-control`, id: `${t}-${d.lastID}` },
                                c = C("label", l, { for: n.id }).outerHTML;
                            ...
                            let f = o ? "none" : "block";
                            "value" === t && (f = r.subtype && "quill" === r.subtype && "none"), (s = C("div", [c, u], { className: `form-group ${t}-wrap`, style: "display: " + f }));
                        }
                        return s.outerHTML;
                    },
                    ce = (e) => {
                        const { type: t } = e,
                            r = [];
                        let o = "";
                        return ["header", "paragraph", "button"].includes(t) && r.push(!0), r.some((e) => !0 === e) || (o = ie("required", e, { first: c.a.get("required") })), o;
                    },
                    ue = function (t, i = !0) {
                        const l = xe(t);
                        ...
                        let f = [
                            C("a", null, { type: "remove", id: "del_" + d.lastID, className: `del-button btn ${w.a}cancel delete-confirm`, title: c.a.get("removeMessage") }),
                            C("a", null, { type: "edit", id: d.lastID + "-edit", className: `toggle-form btn ${w.a}pencil`, title: c.a.get("hide") }),
                            C("a", null, { type: "copy", id: d.lastID + "-copy", className: `copy-button btn ${w.a}copy`, title: c.a.get("copyButtonTooltip") }),
                        ];
                        Q() && f.push(C("a", null, { type: "grid", id: d.lastID + "-grid", className: `grid-button btn ${w.a}grid`, title: "Grid Mode" })), u && Array.isArray(u) && (f = f.filter((e) => !u.includes(e.type)));
                        const m = [C("div", f, { className: "field-actions" })];
                        m.push(C("label", Object(p.x)(s), { className: "field-label" })), m.push(C("span", " *", { className: "required-asterisk", style: t.required ? "display:inline" : "" }));
                        const h = { className: "tooltip-element", tooltip: t.description, style: t.description ? "display:inline-block" : "display:none" };
                        m.push(C("span", "?", h));
                        const g = C("div", "", { className: "prev-holder", dataFieldId: d.lastID });
                        m.push(g);
                        const y = C("div", [_(t), C("a", c.a.get("close"), { className: "close-field" })], { className: "form-elements" }),
                            v = C("div", y, { id: d.lastID + "-holder", className: "frm-holder", dataFieldId: d.lastID });
                        (o.currentEditPanel = v), m.push(v);
                        const x = C("li", m, { class: a + "-field form-field", type: a, id: d.lastID }),
                            O = r(x);
                        let q;
                        if (
                            (fe(O),
                                O.data("fieldData", { attrs: t }),
                                void 0 !== A.stopIndex ? r("> li", b.stage).eq(A.stopIndex).before(O) : P.append(O),
                                r(".sortable-options", O).sortable({ update: () => A.updatePreview(O) }),
                                A.updatePreview(O),
                                Q())
                        ) {
                            const e = "div.row-" + l.rowNumber;
                            (q = P.children(e).length ? P.children(e) : C("div", null, { id: x.id + "-row", className: `row row-${l.rowNumber} ${j}` })),
                                W && U && (H.attr("id", q.id), H.attr("class", q.className), H.attr("style", ""), (q = H));
                            const t = C("div", null, { id: x.id + "-cont", className: `${l.columnSize} ${k}` });
                            W && V && ("true" == H.attr("prepend") ? r(t).prependTo(q) : r(t).insertAfter("#" + H.attr("appendAfter"))),
                                V || r(t).appendTo(q),
                                W || P.append(q),
                                O.appendTo(t),
                                he(q),
                                me(q),
                                l.addedDefaultColumnClass && O.attr("addedDefaultColumnClass", !0),
                                A.tmpCleanPrevHolder(r(g));
                        }
                        e.typeUserEvents[a] && e.typeUserEvents[a].onadd && e.typeUserEvents[a].onadd(x),
                            i && (e.editOnAdd && (A.closeAllEdit(), A.toggleEdit(d.lastID, !1)), x.scrollIntoView && e.scrollToFieldOnAdd && x.scrollIntoView({ behavior: "smooth" })),
                            Q() && (W && V && Ee(q, !0), we()),
                            (W = !1),
                            (U = !1),
                            (V = !1);
                        ...
                        (r(t).sortable({
                            ...
                            receive: function (e, t) {
                                ...
                                if (n && !o) {
                                    const e = r(t.item),
                                        o = xe({}),
                                        n = C("div", null, { id: e.find("li").attr("id") + "-row", className: `row row-${o.rowNumber} ${j}` });
                                    ...
                                    r(t)
                                        ...
                                        .each((e, t) => {
                                            ...
                                            o.addClass("colHoverTempStyle"),
                                                0 == o.index() && r(`<button type="button" class=" ${q} formbuilder-icon-plus btnAddControl ${A.getRowClass(o.parent().attr("class"))}" prepend="true"></button>`).insertBefore(o),
                                                r(`<button type="button" class=" ${q} formbuilder-icon-plus btnAddControl ${A.getRowClass(o.parent().attr("class"))}" appendAfter="${o.attr("id")}"></button>`).insertAfter(o);
                                        });
                                })(r(t.currentTarget));
                            }),
                            r(t).off("mouseleave"),
                            ...
                            (function () {
                                if (!r.rowNumber) {
                                    ...
                                    (o = 0 == h.length ? 1 : Math.max(...h) + 1),
                                        (r.rowNumber = o),
                                        W && V && (r.rowNumber = A.getRowValue(H.attr("class"))),
                ...
                const Ae = function (e, t) {
                    const r = { selected: t ? "checkbox" : "radio" },
                        o = {
                            ...
                            array: (e) => ["select", e.map(({ label: e, value: t }) => C("option", e, { value: t }))],
                            object: (e) => {
                                let { tag: t, content: r } = e;
                                return [t, r, x(e, ["tag", "content"])];
                            },
                        };
                    e = O(O({}, { selected: !1, label: "", value: "" }), e);
                ...
                P.on("change", [".prev-holder input", ".prev-holder select", ".prev-holder textarea"].join(", "), (e) => {
                    ...
                    P.on("keyup", "input.error", ({ target: e }) => r(e).removeClass("error")),
                    ...
                    P.on("click touchstart", ".btnAddControl", function (e) {
                        ...
                        (z = M.clone()),
                            ...
                            P.append(z),
                            0 == t.index()
                                ? z.css({ position: "fixed", left: t.offset().left, top: t.offset().top - r(window).scrollTop() })
                                : z.css({ position: "fixed", left: t.offset().left - 80, top: t.offset().top - r(window).scrollTop() });
                        const o = z.offset().top + z.outerHeight(),
                            n = r(window).scrollTop() + r(window).innerHeight();
                        o > n && z.css({ top: parseInt(z.css("top")) - (o - n) });
                    }),
                    P.on("click touchstart", `.${w.a}copy`, function (t) {
                        ...
                        !(function (e, t) {
                            ...
                            const o = r("#className-" + t.attr("id")),
                                n = xe({}),
                                i = C("div", null, { id: e.attr("id") + "-row", className: `row row-${n.rowNumber} ${j}` }),
                                l = C("div", null, { id: e.attr("id") + "-cont", className: `${A.getBootstrapColumnClass(o.val())} ${k}` });
                            let a;
                ...
                function Ee(e, t = !1) {
                    ...
                    e.children("div" + T).each((e, o) => {
                        ...
                        t || "true" != i.find("li").attr("manuallyChangedDefaultColumnClass")
                            ? A.syncBootstrapColumnWrapperAndClassProperty(o.id.replace("-cont", ""), n)
                            : A.showToast(`Preserving column size of field ${e + 1} because you had personally adjusted it`, 4e3);
                    });
                }
                function Ne(e) {
                    if (e) {
                ...
                function De() {
                    if (Te() || !Q()) return;
                    const e = xe({}),
                        t = C("div", null, { id: A.incrementId(d.lastID) + "-row", className: `row row-${e.rowNumber} ${j}` });
                    P.append(t),
                        he(t),
                        be(),
                        P.find(B)
                            .eq(0)
                            .removeClass(N)
                            .css({ height: P.css("height"), backgroundColor: "transparent" });
                }
                function Be(e = !0) {
                    if (e)
                        (je = !0),
                            A.showToast("Starting Grid Mode - Use the mousewheel to resize.", 1500),
                            M.css("display", "none"),
                ...
                function Le() {
                    ...
                    Ce.closest(S)
                        ...
                        .each((e, t) => {
                            ...
                            let l = "";
                            Ce.attr("id") == o && (l = "currentGridModeFieldHighlight"),
                                r(J)
                ...
                if (
                    (P.on("click touchstart", ".grid-button", (e) => {
                        ...
                        P.bind("mousewheel", function (e) {
                            if (je) {
                                ...
                                if (
                                    ...
                                    return void A.showToast('<b class="formbuilder-required">There is a maximum of 12 columns per row</b>');
                        ...
                        P.on("mouseover mouseout", ".remove, .del-button", (e) => r(e.target).closest("li").toggleClass("delete")),
                        K(),
                                ...
                                c.a
                                    ...
                                    .then(() => {
                                        t.each((e) => {
                                            ...
                                            jQuery(t[e]).data("formBuilder", r), Object.assign(F, r.actions, { markup: p.t }), (F.instance.actions = r.actions);
                                        }),
