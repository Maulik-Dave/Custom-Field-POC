...
!function(e) {
    ...
    !function(e) {
        ...
        const s = function(e, t=!1) {
          ...
          , f = (e,t)=>{
            let r;
            return e = m(e),
            t && (Array.isArray(t) ? r = k(t.join(" ")) : ("boolean" == typeof t && (t = t.toString()),
            r = k(t.trim()))),
            {
                name: e,
                value: t = t ? `="${r}"` : ""
          ...
          , L = (e,t)=>{
            ...
            for (const o in t)
                r.hasOwnProperty(o) && (Array.isArray(t[o]) ? r[o] = Array.isArray(e[o]) ? E(e[o].concat(t[o])) : t[o] : "object" == typeof t[o] ? r[o] = L(e[o], t[o]) : r[o] = t[o]);
            return r
        }
    ...
    , function(e, t, r) {
        ...
        class a {
            ...
            on(e) {
                const t = {
                    ...
                    render: e=>{
                        ...
                        this.js && !Object(o.s)(this.js) ? Object(o.o)(this.js).done(t) : t()
                    }
                };
                return e ? t[e] : t
            }
            ...
            markup(e, t="", r={}) {
                return this.element = Object(o.t)(e, t, r),
                this.element
            }
            parsedHtml(e) {
                return Object(o.x)(e)
 ...
 */
    ...
    , function(e, t, r) {
        ...
        class i {
            ...
            configure() {}
            build(e, t, r) {
                this.preview && (t.name ? t.name = t.name + "-preview" : t.name = o.g.nameAttr(t) + "-preview"),
                t.id = t.name,
    ...
    , function(t, r, o) {
        ...
        class w extends n.a {
            ...
            build() {
                ...
                this.field = this.markup("textarea", this.parsedHtml(t), r),
                this.field
            }
            onRender() {
                this.config.userData && e("#" + this.config.name).val(this.config.userData[0])
        ...
        class x extends w {
            configure() {
                if (this.js = ["https://cdnjs.cloudflare.com/ajax/libs/tinymce/4.9.11/tinymce.min.js"],
                this.classConfig.js) {
    ...
    , , , , , , function(t, r, o) {
        ...
        class y {
                ...
                if (0 !== t.childNodes.length) {
                    ...
                    i.length && i.forEach(t=>{
                        ...
                        if (!i.hasClass("disabled-field")) {
                            ...
                            if (l = Object.assign({}, l, n.getAttrVals(t)),
                            l.subtype)
                                if ("quill" === l.subtype) {
                            ...
                            l = Object(p.D)(l);
                            l.type && l.type.match(o.optionFieldsRegEx) && (l.values = n.fieldOptionData(i)),
                            r.push(l)
                        }
                    }
                    )
            ...
            getAttrVals(t) {
                ...
                return Object(p.j)(o, t=>{
                    const n = o[t]
                      ...
                      , l = [[n.attributes.contenteditable, ()=>"xml" === m.a.opts.dataType ? Object(p.h)(n.innerHTML) : n.innerHTML], ["checkbox" === n.type, ()=>n.checked], ["number" === n.type && "" !== n.value, ()=>Number(n.value)], [n.attributes.multiple, ()=>e(n).val()], [!0, ()=>n.value]].find(([e])=>!!e)[1]();
                    r[i] = l
                }
                ),
                r
            ...
            removeAllFields(e) {
                const t = c.a.current
                  , r = m.a.opts
                  , o = [];
                if (!e.querySelectorAll(this.formBuilder.fieldSelector).length)
                    return !1;
                r.prepend && o.push(!0),
                r.append && o.push(!0),
                  ...
                  , f = setTimeout(()=>{
                    ...
                    o.tmpCleanPrevHolder(c).forEach(e=>{
                        if (e.columnInfo.columnSize) {
                            d.attr("class") != e.columnInfo.columnSize && (d.attr("class", `${e.columnInfo.columnSize} ${this.formBuilder.colWrapperClass}`),
            ...
            openField(t, r=!0) {
                ...
                return this.formBuilder.preserveTempContainers.push(s.attr("id")),
                a.insertAfter(d),
            ...
            processActionButtons(e) {
                ...
                let n = t;
                const i = this.data;
                n = n ? c.a.current[n] || n : o.id ? c.a.current[o.id] || Object(p.e)(o.id) : "",
            ...
            processSubtypes(e) {
                ...
                const r = b.a.getRegisteredSubtypes()
                  , o = Object.entries(r).reduce((e,[r,o])=>(e[r] = t[r] && Object(p.B)(t[r], o) || o,
                e), {})
                  , n = {};
                for (const e in o)
            ...
            tmpCleanPrevHolder(t) {
                ...
                function i(e) {
                    ...
                    if (void 0 !== t && !1 !== t) {
                        ...
                        e.attr("class", e.attr("class").replace("col-", "tmp-col-")),
                        e.attr("class", e.attr("class").replace("row", "tmp-row"));
                        const n = {};
                        n.field = e,
                        n.columnInfo = t,
                        o.push(n)
            ...
            showToast(t, r=3e3) {
                null != this.toastTimer && (window.clearTimeout(this.toastTimer),
                this.toastTimer = null),
        ...
        class v {
            ...
            orderFields(e) {
                ...
                o = Object.keys(o).map(e=>o[e])) : o = Object(p.E)(r),
                o.forEach(e=>{
        ...
        function I(e, t, r) {
            ...
            Q() ? M.sortable({
                ...
                scroll: !1,
                start: (e,t)=>{
                    A.startMoving.call(A, e, t),
                    R = !0
                }
                ,
                stop: (e,t)=>{
                    A.stopMoving.call(A, e, t),
                    R = !1,
                    we()
                }
                ,
                ...
                update: function(t) {
                    ...
                    A.doCancel)
                        return !1;
                    r(t.target).attr("id") == M.attr("id") && pe(),
                    A.setFieldOrder(M),
                ...
                update: function(t, r) {
                    if (A.doCancel)
                        return !1;
                    r.item.parent()[0] === b.stage ? (A.doCancel = !0,
                    Y(r.item)) : (A.setFieldOrder(M),
                    A.doCancel = !e.sortableControls)
                }
            }),
            ...
            const Y = t=>{
                if (t[0].classList.contains("input-set-control")) {
                    ...
                    r.forEach(e=>{
                        Z(e, !0),
                        (A.stopIndex || 0 === A.stopIndex) && A.stopIndex++
                    }
                    )
                } else
                    Z(t, !0)
            ...
            const K = function(t) {
                ...
                b.stage.classList.remove("empty")) : e.defaultFields && e.defaultFields.length ? (m.a.opts.defaultFields.forEach(e=>$(e)),
                A.addDefaultFields()) : e.prepend || e.append || (b.stage.classList.add("empty"),
            ...
            const _ = t=>{
                const {type: r} = t
                  ...
                  , i = (e=>{
                    ...
                    e in I.registeredSubtypes && !(e in o) && (o[e] = t.concat(["subtype"])),
                    o["checkbox-group"] = o.checkbox,
                    o["radio-group"] = o.checkbox;
                    const n = o[e];
                    return "radio-group" === e && Object(p.y)("toggle", n),
                    ["header", "paragraph", "button"].includes(e) && Object(p.y)("description", n),
            ...
            const ie = (e,t,r={})=>{
              ...
              , ue = function(t, i=!0) {
                ...
                i && (e.editOnAdd && (A.closeAllEdit(),
                A.toggleEdit(d.lastID, !1)),
                x.scrollIntoView && e.scrollToFieldOnAdd && x.scrollIntoView({
                    behavior: "smooth"
                })),
                Q() && (W && V && Ee(q, !0),
                we()),
            ...
            function fe(e) {
                Q() && e.mouseenter((function(e) {
                    je || (pe(),
                    r(this).closest(S).prevAll(B).first().removeClass(N),
                    r(this).closest(S).nextAll(B).first().removeClass(N),
                    Ce = r(this),
                    ke = e.pageX,
                    qe = e.pageY)
                }
            ...
            function me(e) {
                const t = r(e).clone();
                if (t.addClass(N).addClass(E).html(""),
                t.css("height", "1px"),
            ...
            function he(t) {
                Q() && (r(t).sortable({
                    ...
                    helper: function(e, t) {
                        const r = t.clone();
                        return r.find(".field-actions").remove(),
                        r.css({
                            width: "20%",
                            height: "100px",
                            minHeight: "60px",
                    ...
                    over: function(e) {
                        ...
                        o || (pe(),
                        t.prevAll(B).first().removeClass(N).css("height", "40px"),
                        t.nextAll(B).first().removeClass(N).css("height", "40px"))
                    },
                    out: function(e) {
                        P.children(B).removeClass("hoverDropStyleInverse"),
            ...
            function xe(t) {
                let r = {};
                return Q() ? (r = A.tryParseColumnInfo(t),
                function() {
                    if (!r.rowNumber) {
                        let o;
            ...
            const Ae = function(e, t) {
                const r = {
                  ...
                  , o = {
                    ...
                    array: e=>["select", e.map(({label: e, value: t})=>C("option", e, {
                        value: t
                    }))],
                    object: e=>{
            ...
            P.on("change", [".prev-holder input", ".prev-holder select", ".prev-holder textarea"].join(", "), e=>{
                ...
                if (["select", "checkbox-group", "radio-group"].includes(r.type)) {
                    ...
                    Object(p.j)(t, e=>{
                        if (t[e].classList.contains("other-option"))
                            return;
            ...
            P.on("click touchstart", `.${w.a}copy`, (function(t) {
                ...
                !function(e, t) {
                    ...
                    let a;
                    r(l).appendTo(i),
                    t.parent().is("div") ? a = t.closest(S) : t.parent().is("ul") && (a = t);
                    r(i).insertAfter(a),
                    e.appendTo(l),
                    he(i),
                    Ne(e.attr("id"))
            ...
            function De() {
                ...
                he(t),
                be(),
                P.find(B).eq(0).removeClass(N).css({
                    height: P.css("height"),
            ...
            P.bind("mousewheel", (function(e) {
                if (je) {
                    ...
                    let n;
                    if (n = e.originalEvent.wheelDelta / 120 > 0 ? parseInt(o) + 1 : parseInt(o) - 1,
                    n > 12)
                        return void A.showToast('<b class="formbuilder-required">Column Size cannot exceed 12</b>');
                    if (n < 1)
                        return void A.showToast('<b class="formbuilder-required">Column Size cannot be less than 1</b>');
                    ...
                    A.syncBootstrapColumnWrapperAndClassProperty(Ce.attr("id"), n),
                    Ce.attr("manuallyChangedDefaultColumnClass", !0),
                    Le(),
                    A.toggleHighlight(Ce)
                }
            }
            ...
            r(document).keydown(e=>{
                if (je) {
                    ...
                    83 != e.keyCode && 40 != e.keyCode || function(e) {
                    ...
                    65 != e.keyCode && 37 != e.keyCode || function() {
            ...
            o.actions = {
                ...
                setLang: e=>{
                    c.a.setCurrent.call(c.a, e).then(()=>{
                        ...
                        A.formActionButtons().forEach(e=>b.formActions.appendChild(e))
                    }
                    )
                }
                ,
        ...
        jQuery.fn.formBuilder = function(e={}, ...t) {
            ...
            if (F[e])
                return "function" == typeof F[e] ? F[e].apply(this, t) : F[e]
        }
    }
    ])
}(jQuery);
